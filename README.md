...
- A dedicated demo org (not production)
- The Salesforce username for that org (see step 3 — it may differ from your work email)
- The Salesforce CLI installed (step 2)
- About 20 minutes
